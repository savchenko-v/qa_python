...
class TestBooksCollector:
    ...
    def test_add_new_book_add_book_valid_number_symbols(self, book, collector):
        collector.add_new_book(book)
        assert len(collector.get_books_genre()) == 1

    # проверка, что нельзя добавить книгу с названием меньше 1 и больше 40 символов; граничные значения - 0 и 41
    @pytest.mark.parametrize('book',
                             [
                                 '',
    ...
    def test_add_new_book_add_book_invalid_number_symbols(self, book, collector):
        collector.add_new_book(book)
    ...
    def test_set_book_genre_set_genre_not_included_in_list(self, collector):
        collector.add_new_book('Мастер и Маргарита')
    ...
    def test_get_book_genre_added_books(self, collector):
        collector.add_new_book('Дюна')
    ...
    def test_get_books_genre_with_added_books(self, collector):
        collector.add_new_book('Десять негритят')
        collector.set_book_genre('Десять негритят', 'Детективы')
        collector.add_new_book('Дюна')
        collector.set_book_genre('Дюна', 'Фантастика')
    ...
    def test_get_books_for_children_add_one_right_genre(self, collector):
    ...
    def test_add_book_in_favorites_add_same_book(self, collector):
    ...
    def test_get_list_of_favorites_books_get_three_books(self, collector):
        collector.add_new_book('Горе от ума')
